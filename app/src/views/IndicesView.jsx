      ...
      cards: [
        {
          ...
          body: 'Kalshi, ForecastEx, CME, and Polymarket normalized into a comparable CPI market stack. Kalshi + ForecastEx are the governed baseline; CME is a shadow constituent candidate; Polymarket is a diagnostic / dislocation input.',
          badge: { variant: 'accent', label: 'Kalshi · ForecastEx · CME · Polymarket' },
          icon: 'globe',
        },
        {
          key: 'parity',
          title: 'Validation & Publishability',
          body: 'OTC parity, SDR cross-checks, calibration evidence, and publication controls for trusted reference outputs.',
          badge: { variant: 'success', label: 'Validation controls' },
          icon: 'shield',
        },
      ],
    },

...
def score_and_package(
    ...
    # Polymarket's macro-indicators tag can carry MoM markets, bracket
    # contracts, and other non-YoY questions mixed in with US CPI YoY. Drop
    # contracts whose threshold falls outside the plausible CPI YoY band so
